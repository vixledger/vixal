...
inline void
from_string_with(U (&conv)(const string &, size_t *, int),
                 const string &s, T *rp) {
    std::size_t pos;
...
template<typename T, typename U>
inline void
from_string_with(U (&conv)(const string &, size_t *),
                 const string &s, T *rp) {
    std::size_t pos;
    U r(add_base(conv, s, &pos));
    T t = r;
...
void from_string(const string &s, int *rp) {
    from_string_with(std::stoi, s, rp);
}

void from_string(const string &s, long *rp) {
    from_string_with(std::stol, s, rp);
}

void from_string(const string &s, long long *rp) {
    from_string_with(std::stoll, s, rp);
}

void from_string(const string &s, unsigned char *rp) {
    from_string_with(std::stoul, s, rp);
}

void from_string(const string &s, unsigned short *rp) {
    from_string_with(std::stoul, s, rp);
}

void from_string(const string &s, unsigned int *rp) {
    from_string_with(std::stoul, s, rp);
}

void from_string(const string &s, unsigned long *rp) {
    from_string_with(std::stoul, s, rp);
}

void from_string(const string &s, unsigned long long *rp) {
    from_string_with(std::stoll, s, rp);
}

void from_string(const string &s, float *rp) {
    from_string_with(std::stof, s, rp);
}

void from_string(const string &s, double *rp) {
    from_string_with(std::stod, s, rp);
}

void from_string(const string &s, long double *rp) {
    from_string_with(std::stold, s, rp);
}

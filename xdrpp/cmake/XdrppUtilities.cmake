################################################################################
# XdrppUtilities.cmake - part of CMake configuration of SOCI library
#
...
#
#   xdrpp_check_package_found: Test varname-FOUND for case-insensitive varname
#
################################################################################
...
# uppercase.
#
macro(xdrpp_check_package_found NAME SUCCESS)
  ...
  #message(STATUS "xdrpp_check_package_found: ${SUCCESS}=${${SUCCESS}}")
endmacro()

#
# Pretty-print of given property of current directory.
#
function(xdrpp_report_directory_property PROPNAME)
...
# For instance, on Windows, libraries get ABI version suffix xdrpp_coreXY.{dll|lib}.
#
function(xdrpp_target_output_name TARGET_NAME OUTPUT_NAME)

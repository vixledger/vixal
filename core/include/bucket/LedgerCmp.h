 ...
 *
 * Equivalently: Two LedgerEntries have the same 'identity' iff their corresponding LedgerKeys are exactly equal.
 * This operator _could_ be implemented in terms of extracting 2 LedgerKeys from 2 LedgerEntries and doing operator<
 * on them, but that would be comparatively inefficient.
 */

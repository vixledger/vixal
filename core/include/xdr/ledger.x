...
/**
 * VixalValue is the value used by SCP to reach consensus on a given ledger
 */
struct VixalValue {
...
struct LedgerHeader {
    ...
    VixalValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from VixalValue is normalized such that

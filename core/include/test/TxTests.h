...
struct ThresholdSetter {
    optional<uint32> masterWeight;
    optional<uint32> lowThreshold;
    optional<uint32> medThreshold;
    optional<uint32> highThreshold;
};
...
Operation allowTrust(PublicKey const &trustor, Asset const &asset, bool authorize);
...
void checkTx(int index, TxSetResultMeta &r, TransactionResultCode expected, OperationResultCode code);

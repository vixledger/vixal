...
private:
    ...
    static void loadLines(StatementContext &prep, LedgerEntryProcessor trustProcessor);
...
public:
    ...
    static void deleteTrustLinesModifiedOnOrAfterLedger(Database &db, uint32_t oldestLedger);

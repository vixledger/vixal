...
// note: entries generated are valid in the sense that they are sane by themselves
// it does NOT mean that it makes sense relative to other entries:
// for example the numsubentries of a related account is not updated when generating a 'valid' trust line

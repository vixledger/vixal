...
public:
    ...
    static void deleteAccountsModifiedOnOrAfterLedger(Database& db, uint32_t oldestLedger);
    ...
    static AccountFrame::pointer loadAccount(AccountID const &accountID, Database &db);

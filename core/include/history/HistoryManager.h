 ...
 * stored at .well-known/vixal-history.json as a JSON file.
 *
 ...
 *
 * While the _most recent_ checkpoint is in .well-known/vixal-history.json,
...
public:
    /// Status code returned from LedgerManager::verifyCatchupCandidate. Look there for additional documentation.
    ...
    // .well-known/vixal-history.json to it.

...
/***
 * This Invariant is used to validate that LedgerEntries meet a number of simple requirements, such as bounds
 * checking for a variety of fields. The Invariant also checks that the lastModifiedLedgerSeq equals the ledgerSeq
 * of the LedgerHeader.
 */

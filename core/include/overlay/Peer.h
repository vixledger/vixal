...
protected:
    ...
    void recvMessage(VixalMessage const &msg);

    void recvMessage(AuthenticatedMessage const &msg);

    void recvMessage(xdr::msg_ptr const &xdrBytes);

    virtual void recvError(VixalMessage const &msg);

    // returns false if we should drop this peer
    void noteHandshakeSuccessInPeerRecord();

    void recvAuth(VixalMessage const &msg);

    void recvDontHave(VixalMessage const &msg);

    void recvGetPeers(VixalMessage const &msg);

    void recvHello(Hello const &elo);

    void recvPeers(VixalMessage const &msg);

    void recvGetTxSet(VixalMessage const &msg);

    void recvTxSet(VixalMessage const &msg);

    void recvTransaction(VixalMessage const &msg);

    void recvGetSCPQuorumSet(VixalMessage const &msg);

    void recvSCPQuorumSet(VixalMessage const &msg);

    void recvSCPMessage(VixalMessage const &msg);

    void recvGetSCPState(VixalMessage const &msg);
...
public:
    ...
    void sendMessage(VixalMessage const &msg);

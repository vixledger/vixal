...
namespace vixal {
// [testing] Peer that communicates via byte-buffer delivery events queued in in-process io_services.
//
// NB: Do not construct one of these directly; instead, construct a connected pair of them wrapped in a
// LoopbackPeerConnection that explicitly manages the lifecycle of the connection.

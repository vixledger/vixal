...
RepairMissingBucketsWork::RepairMissingBucketsWork(
        Application &app, AbstractWork &parent, HistoryArchiveState const &localState,
        handler endHandler)
        : BucketDownloadWork(app, parent, "repair-buckets", localState), mEndHandler(endHandler) {
}

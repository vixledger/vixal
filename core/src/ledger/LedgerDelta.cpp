...
LedgerDelta::LedgerDelta(LedgerDelta &outerDelta)
        : mOuterDelta(&outerDelta), mHeader(&outerDelta.getHeader()), mCurrentHeader(outerDelta.getHeader()),
          mPreviousHeaderValue(outerDelta.getHeader()), mDb(outerDelta.mDb),
...
template
class LedgerDelta::Iterator<LedgerDelta::KeyEntryMap::const_iterator,
        LedgerDelta::AddedLedgerEntry>;

template
class LedgerDelta::IteratorRange<LedgerDelta::AddedIterator>;
...
template
class LedgerDelta::IteratorRange<LedgerDelta::ModifiedIterator>;

LedgerDelta::ModifiedLedgerEntry::ModifiedLedgerEntry(
        LedgerDelta const &delta, KeyEntryMap::value_type const &pair)
        : key(pair.first), current(pair.second), previous(delta.mPrevious.at(pair.first)) {
}
...
template
class LedgerDelta::Iterator<
        std::set<LedgerKey, LedgerEntryIdCmp>::const_iterator,
        LedgerDelta::DeletedLedgerEntry>;

template
class LedgerDelta::IteratorRange<LedgerDelta::DeletedIterator>;

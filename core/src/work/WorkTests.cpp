...
public:
    CallCmdWork(Application &app, AbstractWork &parent, std::string command)
...
public:
    CountDownWork(Application &app, AbstractWork &parent, size_t count)
            : Work(app, parent, std::string("countdown-") + std::to_string(count)), mCount(count) {
    }
...
public:
    FailingWork(Application &app, AbstractWork &parent,
...
public:
    ...
    WorkCountingOnFailureRaise(Application &app, AbstractWork &parent)
...
public:
    WorkDoNothing(Application &app, AbstractWork &parent,
                  std::string const &uniqueName)
            : Work(app, parent, uniqueName, 0) {
    }
...
public:
    WorkWith2Subworks(Application &app, AbstractWork &parent,
                      std::string const &uniqueName)
            : Work(app, parent, uniqueName, 0) {
    }

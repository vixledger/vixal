...
ApplyLedgerChainWork::ApplyLedgerChainWork(
        ...
        : Work(app, parent, std::string("apply-ledger-chain")), mDownloadDir(downloadDir), mRange(range),
          mCurrSeq(mApp.getHistoryManager().checkpointContainingLedger(mRange.first())),

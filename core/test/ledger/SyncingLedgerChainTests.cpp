...
TEST_CASE("empty syncing ledger chain accepts anything", "[ledger][ledgerchain]") {
...
TEST_CASE("not empty syncing ledger chain accepts next ledger", "[ledger][ledgerchain]") {
    auto ledgerChain = SyncingLedgerChain{};

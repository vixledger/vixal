...
TEST_CASE("change trust", "[tx][changetrust]") {
    ...
    SECTION("basic tests") {
        for_all_versions(*app, [&] {
            ...
            REQUIRE_THROWS_AS(root.changeTrust(idr, 0), ex_CHANGE_TRUST_INVALID_LIMIT);
            ...
            REQUIRE_THROWS_AS(root.changeTrust(idr, 89), ex_CHANGE_TRUST_INVALID_LIMIT);
    ...
    SECTION("issuer does not exist") {
        SECTION("new trust line") {
            for_all_versions(*app, [&] {
                ...
                REQUIRE_THROWS_AS(root.changeTrust(usd, 100), ex_CHANGE_TRUST_NO_ISSUER);
            });
        }
        SECTION("edit existing") {
            ...
            for_all_versions(*app, [&] {
                ...
                REQUIRE_THROWS_AS(root.changeTrust(idr, 99), ex_CHANGE_TRUST_NO_ISSUER);

...
void postgresql_session_backend::begin(const char *beginTx) {
    hard_exec(*this, conn_, beginTx, "Cannot begin transaction.");
    transactionLevel_++;
}

void postgresql_session_backend::commit(const char *commitTx) {
    transactionLevel_--;
    hard_exec(*this, conn_, commitTx, "Cannot commit transaction.");
}

void postgresql_session_backend::rollback(const char *rollbackTx) {
    transactionLevel_--;
    hard_exec(*this, conn_, rollbackTx, "Cannot rollback transaction.");
}
